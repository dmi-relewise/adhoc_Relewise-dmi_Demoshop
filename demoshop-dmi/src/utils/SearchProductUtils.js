...
export const createSearcher = () => { return new Searcher( process.env.REACT_APP_RELEWISE_KEY_1,  process.env.REACT_APP_RELEWISE_KEY_2, { serverUrl: process.env.REACT_APP_RELEWISE_URL});};
